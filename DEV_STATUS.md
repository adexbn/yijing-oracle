...
- 最后更新：2026-09-25
- 最近提交：`b2dba54`（分支 `main`；更准确以 `git log` 为准）
- 待提交（本轮）：`ios/Yijing/Services/LlamaCPP.swift`、`ios/Yijing/Services/LocalAiClient.swift`、`ios/project.yml`（iOS 真正开启思考，1.3.0 / build 8）、`DEV_STATUS.md`、`docs/PERF_AUDIT.md`（含新增第 9 节）、`docs/IOS_LOG_CHECKLIST.md`
